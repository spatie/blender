...
/***/ function(module, exports, __webpack_require__) {
	...
	function init() {
	    ...
	    if (chartData) {
	        (function () {
	            new _chart2.default(chartData.ctx).Line(chartData.chart, {
	                bezierCurve: false,
	                responsive: true,
	            ...
	            if ($legend.length) {
	                $(chartData.chart.datasets).each(function () {
	                    ...
	                    var $bullet = $('<span></span>').css('background', this.fillColor).addClass('chart__legend__bullet');
	                    var $label = $('<span></pan>').text(this.label).addClass('chart__legend_description');
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
		...
		var each = helpers.each = function(loopable,callback,self){
			...
			amd = helpers.amd = ("function" === 'function' && __webpack_require__(349)),
			//-- Math methods
